...
class Test(unittest.TestCase):
    def test_para_html(self):
        ...
        item_package = ItemPackage(item_id=item['id'], item_version=item['version'])
    ...
    def test_subitem_html(self):
        item = CatalogDB().item(uri='/scriptures/ot')
        item_package = ItemPackage(item_id=item['id'], item_version=item['version'])
    ...
    def test_subitems(self):
        item = CatalogDB().item(uri='/manual/family-finances')
        item_package = ItemPackage(item_id=item['id'], item_version=item['version'])
    ...
    def test_related_audio_items(self):
        item = CatalogDB().item(uri='/manual/new-testament-stories')
        item_package = ItemPackage(item_id=item['id'], item_version=item['version'])
